export default function AboutSection() {
  return (
    <section id="about" className="py-24 bg-[#F2F1E8]">
      <div className="container px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
              ...
              <div className="border-l-4 border-[#1A1A1A] pl-6">
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-2">Our Vision</h3>
                <p className="text-[#1A1A1A]">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-[#1A1A1A] p-4 text-white">
              <p className="text-sm font-medium">Opening June 2025 in Clark Global City</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 relative">
            <div className="absolute top-0 left-0 w-16 h-1 bg-[#1A1A1A]"></div>
            <h3 className="text-xl font-bold text-[#1A1A1A] mb-4">World-Class Facilities</h3>
            <p className="text-[#1A1A1A]">
          ...
          <div className="bg-white p-8 relative">
            <div className="absolute top-0 left-0 w-16 h-1 bg-[#1A1A1A]"></div>
            <h3 className="text-xl font-bold text-[#1A1A1A] mb-4">Cultural Programming</h3>
            <p className="text-[#1A1A1A]">
          ...
          <div className="bg-white p-8 relative">
            <div className="absolute top-0 left-0 w-16 h-1 bg-[#1A1A1A]"></div>
            <h3 className="text-xl font-bold text-[#1A1A1A] mb-4">Community Engagement</h3>
            <p className="text-[#1A1A1A]">
