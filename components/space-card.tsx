    ...
    >
      {hasImage ? (
        ...
        <div className="aspect-[4/3] bg-[#E5E3D7] flex items-center justify-center">
          <span className="text-[#1A1A1A] text-lg">No image available</span>
        </div>
      )}
      <div className="p-6">
        <h3 className="text-xl font-bold text-[#1A1A1A] mb-2">{title}</h3>
        <p className="text-[#1A1A1A] mb-4">{description}</p>
        <Link href="#" className="text-[#1A1A1A] hover:text-[#8B7E66] flex items-center">
